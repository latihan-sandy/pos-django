var transactionInit = function() {
    ...
    $("#form-invoice").submit(function(e) {
        ...
        if (!customer_id) {
            ...
            toastShow({
                "title": "Warning",
                "message": "The petty cash must equals or bigger than " + grandtotal + " !!",
                "mode": "warning"
            });
        } else {
            let form = this;
...
$(document).ready(function() {
    ...
    let dataTableColumns = [{
        ...
        name: 't_invoice_number',
        data: 't_invoice_number'
    }, {
        name: 't_customer',
        data: 't_customer',
    ...
    if ($("#table-data").length) {
        dataTableInit({
            ...
            "route": "/transaction/sales/datatable",
